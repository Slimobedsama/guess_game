...
const subContent4 = document.querySelector('div.sub-content-4') as HTMLDivElement;
const msg = document.querySelector('p.msg') as HTMLParagraphElement;
const dataInput = document.querySelector('#figure') as HTMLInputElement;
const currentRandom = document.querySelector('.current-dis-1') as HTMLParagraphElement;
const currentGuess = document.querySelector('.current-dis-2') as HTMLParagraphElement;
const previousRandomNum = document.querySelector('.previous-dis-1') as HTMLParagraphElement;
const previousGuess = document.querySelector('.previous-dis-2') as HTMLParagraphElement;
const enterButton = document.querySelector('div input[value="Enter"]') as HTMLButtonElement;
const clearButton = document.querySelector('div input[value="Clear"]') as HTMLButtonElement;
